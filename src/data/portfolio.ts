...
export const certificates: Certificate[] = [
  { name: "Google CyberSecurity Professional Certificate", issuer: "Google coursera", year: "2025", image: `${BASE}Google .jpeg` },
  { name: "Certified Ethical Hacker (v12)", issuer: "Google coursera", year: "2025", image: `${BASE}CEH(V12).jpeg` },
  { name: "Pre Security", issuer: "TryHackMe", year: "2025", image: `${BASE}Pre Security.jpeg` },
  { name: "Cyber Security 101", issuer: "TryHackMe", year: "2025", image: `${BASE}CS101.jpeg` },
  { name: "Web Fundamentals", issuer: "TryHackMe", year: "2025", image: `${BASE}WF.jpeg` },
  { name: "Jr Penetration Tester", issuer: "TryHackMe", year: "2025", image: `${BASE}Jr PT.jpeg` },
  { name: "CompTIA PenTest+", issuer: "TryHackMe", year: "2025", image: `${BASE}Comptia.jpeg` },
  { name: "SOC Level 1", issuer: "TryHackMe", year: "2025", image: `${BASE}SOC L1.jpeg` },
  { name: "SOC Level 2", issuer: "TryHackMe", year: "2025", image: `${BASE}SOC L2.jpeg` },
  { name: "Security Engineer", issuer: "TryHackMe", year: "2025", image: `${BASE}SE.jpeg` },
  { name: "Red Teaming", issuer: "TryHackMe", year: "2025", image: `${BASE}RT.jpeg` },
  { name: "Web Application Pentesting", issuer: "TryHackMe", year: "2025", image: `${BASE}WAP.jpeg` },
  { name: "Advanced Endpoint Investigation", issuer: "TryHackMe", year: "2025", image: `${BASE}Advanced Endpoint.jpeg` },
  { name: "Endpoint Security", issuer: "Cisco Network Academy", year: "2025", image: `${BASE}ES.jpeg` },
  { name: "Junior Cybersecurity Analyst Career Path Exam", issuer: "Cisco Network Academy", year: "2025", image: `${BASE}Jr Cyber Analyst.jpeg` },
  { name: "Network Defense", issuer: "Cisco Network Academy", year: "2025", image: `${BASE}ND.jpeg` },
  { name: "Networking Device and Initial Configuration", issuer: "Cisco Network Academy", year: "2025", image: `${BASE}Network DC.jpeg` },
  { name: "Networking Basics", issuer: "Cisco Network Academy", year: "2025", image: `${BASE}NB.jpeg` },
  { name: "Cyber Threat Management", issuer: "Cisco Network Academy", year: "2025", image: `${BASE}CTM.jpeg` },
  { name: "Ethical Hacking", issuer: "Cisco Network Academy", year: "2025", image: `${BASE}EH.jpeg` },
  { name: "Junior DevOps Engineer", issuer: "VibeSecurity", year: "2026", image: `${BASE}JDE.png` },
  { name: "Junior GRC Analyst", issuer: "VibeSecurity", year: "2026", image: `${BASE}JGRC.png` },
  { name: "Junior Security Operations Center (JSOC)", issuer: "VibeSecurity", year: "2026", image: `${BASE}JSOC.png` },
  { name: "Domain 1: Security Principles", issuer: "ISC2", year: "2025", image: `${BASE}Domain 1.png` },
  { name: "Domain 2: Incident Response, Business Continuity and Disaster Recovery Concepts", issuer: "ISC2", year: "2025", image: `${BASE}Domain 2.png` },
  { name: "Domain 3: Access Control Concopts", issuer: "ISC2", year: "2025", image: `${BASE}Domain 3.png` },
  { name: "Domain 4: Network Security", issuer: "ISC2", year: "2025", image: `${BASE}Domain 4.png` },
  { name: "Domain 5: Security Oporations", issuer: "ISC2", year: "2025", image: `${BASE}Domain 5.png` },
  { name: "Mastering Network Security : Defending Against Cyber Threat", issuer: "Udemy", year: "2025", image: `${BASE}Master NS.jpeg` },
  { name: "Computer Forensics and Digital Forensics Masterclass PRO+", issuer: "Udemy", year: "2025", image: `${BASE}Forensic.jpeg` },
  { name: "Ethical Hacking: Full 60 Hour Red Team & Penetration Testing", issuer: "Udemy", year: "2025", image: `${BASE}EH60.jpeg` },
  { name: "DVWA for Ethical Hackers: Master Web App Attacks", issuer: "Udemy", year: "2026", image: `${BASE}DVWA.jpeg` },
  { name: "SOC for Blue Teaming", issuer: "Udemy", year: "2026", image: `${BASE}SOC Blue.jpeg` },
  { name: "Metasploit from Scratch: Beginner to Professional", issuer: "Udemy", year: "2025", image: `${BASE}Metasploit.jpeg` },
  { name: "Java Network Programming - Mastering TCP/IP : CJNP+ JAVA+", issuer: "Udemy", year: "2025", image: `${BASE}Java.jpeg` },
  { name: "Wireless Networks & SDR 2025:GSM,SS7,GPRS,LTE & 5G Facts", issuer: "Udemy", year: "2025", image: `${BASE}Wireless.jpeg` },
  { name: "Windows Password Cracking", issuer: "Udemy", year: "2025", image: `${BASE}Password.jpeg` },
  { name: "Web Hacking", issuer: "Udemy", year: "2025", image: `${BASE}WH.jpeg` },
  { name: "Burp Suite: In Depth Survival Guide", issuer: "Udemy", year: "2025", image: `${BASE}Burp.jpeg` },
  { name: "Kali Linux for Ethical Hacking", issuer: "Udemy", year: "2025", image: `${BASE}Kalilinux.jpeg` },
  { name: "Cyber Security & Ethical Hacking", issuer: "Udemy", year: "2025", image: `${BASE}CSEH.jpeg` },
  { name: "Offensive Security Pathway", issuer: "Udemy", year: "2025", image: `${BASE}OSP.jpeg` },
  { name: "Complete Ethical Hacking Course: Go From Zero to Hero", issuer: "Udemy", year: "2025", image: `${BASE}Complete EH.jpeg` },
  { name: "Microsoft Sentinel: Zero to Hero - Complete SIEM Training", issuer: "Udemy", year: "2025", image: `${BASE}Microsoft.jpeg` },
  { name: "Certified Online Fraud Prevention Specialist", issuer: "Hack & Fix", year: "2026", image: `${BASE}COFPS.jpeg` },
  { name: "Cyber Security & Ethical Hacking", issuer: "CappricioSec University", year: "2025", image: `${BASE}CSE.jpeg` },
  { name: "CAPIE - Certified API Hacking Expert", issuer: "TheXSSRat", year: "2025", image: `${BASE}CAPIE.jpeg` },
  { name: "Certified Red Team Operations Management (CRTOM)", issuer: "Red Team Leaders", year: "2025", image: `${BASE}CRTOM.jpeg` },
  { name: "Windows API for Red Team Introduction", issuer: "Red Team Leaders", year: "2025", image: `${BASE}Windows API.jpeg` },
  { name: "Offensive Development Introduction for Windows v1", issuer: "Red Team Leaders", year: "2025", image: `${BASE}Offensive Windows.jpeg` },
  { name: "Networking", issuer: "Infosys Springboard", year: "2025", image: `${BASE}Networking.jpeg` },
  { name: "Hands-on Web Penetration Testing with Metasploit 4.x", issuer: "Infosys Springboard", year: "2025", image: `${BASE}WPT.jpeg` },
  { name: "Artificial Intelligence", issuer: "Infosys Springboard", year: "2025", image: `${BASE}AI.jpeg` },
  { name: "OWASP Top 10: Web Application Security", issuer: "Infosys Springboard", year: "2025", image: `${BASE}OWASP.jpeg` },
  { name: "Deloitte - Cyber Job Simulation", issuer: "Forage", year: "2025", image: `${BASE}Deloitte.jpeg` },
  { name: "Mastercard - Cybersecurity Job Simulation", issuer: "Forage", year: "2025", image: `${BASE}Mastercard.jpeg` },
  { name: "PwC Switzerland - Power BI Job Simulation", issuer: "Forage", year: "2025", image: `${BASE}PWC BI.jpeg` },
  { name: "PwC Switzerland - Cybersecurity Job Simulation", issuer: "Forage", year: "2025", image: `${BASE}PWC.jpeg` },
  { name: "Tata Group - Cybersecurity Analyst Job Simulation", issuer: "Forage", year: "2024", image: `${BASE}TATA.jpeg` },
  { name: "AIG - Shields Up: Cybersecurity Job Simulation", issuer: "Forage", year: "2024", image: `${BASE}AIG.jpeg` },
  { name: "Microsoft Security Copilot", issuer: "Linkedin", year: "2025", image: `${BASE}MS.jpeg` },
